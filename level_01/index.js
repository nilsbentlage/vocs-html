...
class VokabelTest {
  ...
  neustart() {
    this.vokabelFeld.innerText = 'Super gemacht!';
    setTimeout(() => {
      alert(
  ...
  vergleicheAntwort() {
    ...
    if (
      ...
      this.zeigeErgebnis("Das war richtig! Super!", "green");
      if (this.vokabeln.length > 0) {
        this.neueVokabelAnzeigen();
      } else {
        this.neustart();
      }
    } else {
      this.zeigeErgebnis("Das war leider falsch. Versuche es noch einmal!", "red");
    }
